...
export const sign_training = new  p5(( sketch ) => {
    ...
    sketch.set = (width, height, socket) => {
        ...
        sketch.sign_training = new Guessing(sketch)
        socket.on(sketch.name, (data) => {
            sketch.sign_training.update_data(
                data["guessed_sign"],
                data["probability"],
                data["actions"] 
            )
    ...
    sketch.show = () => {
        ...
        sketch.clear();
        sketch.sign_training.show(sketch);
    }
});
